function [im_out] = scdl_interp_grad(te_LR, im_h, im_w, nFactor)

if nFactor == 3
    cls_num = 4;
    nOuterLoop = 1;
    nInnerLoop = 1;
    load KMeans_5x5_32_Factor3_g4 vec par param;
end
im_c = size(te_LR,3);
...
for t = 1 : nInnerLoop
  ...
  %  XH = XH - meanX; 
    ...
    [im_out, ~] = patch2data([XH;XL], im_h, im_w, 1,par.win, par.step);
%{
